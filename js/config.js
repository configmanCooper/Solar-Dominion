...
var Config = (function () {
    ...
    var BLOCK_TYPES = {
        ...
        escape_pod:     { code: 'ep', name: 'Escape Pod',       cat: BLOCK_CAT.UTILITY,    weight: 3,   hp: 15,  powerDraw: 1,  powerGen: 0,  cost: 3000,  color: '#ffaa00', placement: 'any', escapePod: true, materials: { metal: 2, electronics: 2, construction_mats: 2 } },
        // Mining equipment
